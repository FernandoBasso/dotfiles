  ...
  config = function()
    ...
    vim.api.nvim_create_autocmd('LspAttach', {
      ...
      callback = function(event)
        ...
        ----
        -- Fuzzy find all the symbols in your current document. Symbols
        -- are things like variables, functions, types, etc.
        --
        map(
          '<leader>ds',
        ...
        ----
        -- Fuzzy find all the symbols in your current workspace. Similar
        -- to document symbols, except searches over your entire
        -- project.
        --
        map(
          '<leader>ws',
        ...
        ----
        -- Execute a code action, usually your cursor needs to be on top
        -- of an error or a suggestion from your LSP for this to
        -- activate.
        --
        map('<leader>ca', vim.lsp.buf.code_action, '[C]ode [A]ction')

        ----
        -- Opens a popup that displays documentation about the word
        -- under your cursor See `:help K` for why this keymap.
        --
        ...
        -- rests there for a little while. See `:help CursorHold` for
        -- information about when this is executed
        --
    ...
    -- everything that is in the LSP specification. When you add
    -- nvim-cmp, luasnip, etc. Neovim now has *more* capabilities. So,
    -- we create new capabilities with nvim cmp, and then broadcast that
    -- to the servers.
    --
    ...
    ----
    -- Ensure the servers and tools above are installed. To check the
    -- current status of installed tools and/or manually install other
    -- tools, you can run:
    --
    --    :Mason
    --
    ...
    require('mason-lspconfig').setup {
      handlers = {
        function(server_name)
          ...
          -- This handles overriding only values explicitly passed by
